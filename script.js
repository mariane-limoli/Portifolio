...
formulario.addEventListener("submit", function () {
  ...
  setTimeout(function () {
    ...
    alert(
      "Obrigada! Formulário enviado com sucesso! Em breve retornarei seu contato."
    );
  }, 1000);
